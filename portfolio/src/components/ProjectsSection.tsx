        ...
        {projects.map((project) => (
          ...
          >
            ...
            <a
              ...
              className="mt-5 inline-flex rounded-lg border border-sky-200 bg-sky-50 px-3 py-1.5 text-xs font-semibold text-sky-700 transition hover:border-sky-300 hover:bg-sky-100"
            >
              {project.ctaLabel}
            </a>
          </article>
